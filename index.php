...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>Chocolate Fondue</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br>Chocolate Fondue was founded in 1989 and we believe in excellent food quality as well as customer satisfaction.<br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
...
?>
            ...
            <p class="text-right">Chocolate Fondue<br><i class="fa fa-map-marker"></i>&nbsp; Prabhat Road <br>Pune <br><br>email: info@domain.com<br>phone: +00 (123) 456 7890</p>
            </div>
